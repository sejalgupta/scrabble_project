"""
Given a dictionary of words, board state, and tiles on rack, selects the 
move with the highest score at each turn, if it can be found.

Original: https://github.com/boringcactus/Appel-Jacobson-scrabble/blob/canon/solver.py
"""

from letter_tree import LetterTree, basic_english
from board import Board, sample_board

class SolveState:

    def __init__(self, dictionary: LetterTree, board: Board, rack: list):
    ...
    def legal_move(self, word, last_pos):
        ...
        positions = [] # positions for the word
        ...
        # print()
        self.words.append((word, positions[::-1]))
